...
namespace Colmart.Models
{
    public class clsCMSUsers
    {
        ...
        [Remote("checkIfCMSUserExists", "CMSUsers", HttpMethod = "POST", ErrorMessage = "Email already exists")]
        ...
        public clsCMSRoleTypes clsCMSRoleType { get; set; }
    }
}
