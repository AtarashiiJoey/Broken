		...
		if( $('#gaugeBasic').get(0) ) {
			var target = $('#gaugeBasic'),
				opts = $.extend(true, {}, {
					...
					colorStart: '#4571b8', // Colors
					colorStop: '#4571b8', // just experiment with them
